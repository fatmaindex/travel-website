            ...
            <div  className="HomeContent container">
                ...
                <div data-aos='fade-right' className="formDiv">
                    ...
                    <div className="searchDiv">
                        ...
                        <div className="input">
                            <input type="text" id='search' placeholder='write name here...' />
                    ...
                    <div className="priceDiv">
                        ...
                        <div className="input">
                            <input type="range" max="5000" min="1000" id='range' />
                        </div>
                    </div>
                    </div>
                        <button className='btn filterOptions'><FaFilter className='filterIcon' /> <span>MORE FILTERS </span></button>
